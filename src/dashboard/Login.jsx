...
export default function Login() {
  ...
  async function handleGoogleSignIn() {
    ...
    if (oauthError) {
      // Only reached if the redirect itself fails (e.g. provider not configured)
      setError(oauthError.message);
      setGoogleLoading(false);
    }
    // On success the browser navigates away — no further action needed here.
    // AuthGuard handles the admin check when /dashboard loads post-redirect.
  }
  ...
  async function handleSubmit(e) {
    ...
    // Guard: confirm admin before granting access
  ...
  return (
    <div className="dash-login">
      <div className="dash-login__card">
        ...
        {/* Google sign-in */}
        <button
          className="dash-btn dash-btn--google dash-btn--full"
          type="button"
